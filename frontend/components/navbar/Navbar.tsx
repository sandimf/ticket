...
import { BookOpenIcon, CalendarPlus, CompassIcon, InfoIcon, LifeBuoyIcon } from 'lucide-react';
  ...
  (
    {
      ...
      signInText = 'Buat Event',
      signInHref = '/event/create',
      ctaText = 'Jelajahi Event',
      ctaHref = '/',
      onSignInClick,
      onCtaClick,
      ...props
    ...
    return (
      <header
        ref={combinedRef}
        className={cn(
          'relative z-10 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 md:px-6 [&_*]:no-underline',
          className
        )}
        {...props}
      >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-6">
              ...
              >
                ...
                <span className="hidden font-bold text-xl sm:inline-block dark:text-white text-black">Lorem</span>
              </button>
              {/* Navigation menu */}
            </div>
          </div>
